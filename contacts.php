...
<p><font color='080e3e' face='Comic Sans MS'><h1> Контакты:</h1></p></font>
...
if($result)
{
    ...
    echo "<table border='1'  bordercolor='#0000FF' align='center'><tr><th bgcolor='#F1F1F1'>№</th><th bgcolor='#F1F1F1'>Подразделение</th><th bgcolor='#F1F1F1'>Телефон</th><th bgcolor='#F1F1F1'>E-mail</th></tr>";
    for ($i = 0 ; $i < $rows ; ++$i)
    {
...
mysqli_close($link);
?>
<p><center><font color='#000000' face='Comic Sans MS'><h5>По общим вопросам Вы можете обратиться по телефону: 578887 или triumph@mail.ru. Мы будем рады помочь Вам!</font></center></h5></p>
</body>
</html>